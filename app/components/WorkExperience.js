...
export default function WorkExperience() {
  return (
    <div className='flex flex-col-reverse items-center justify-center lg:block'>
      ...
      <div className='hover:scale-105 transition-all cursor-pointer lg:absolute lg:left-1/2 lg:-translate-x-1/2 text-center bg-[#264653] border border-black font-bold w-fit px-6 py-6 m-3'>
